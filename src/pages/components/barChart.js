...
function BarChart(props){
    ...
    return <g transform={`translate(${offsetX}, ${offsetY})`}>
        <Bars data={data} xScale={xScale} yScale={yScale} height={height} handleStationHover={handleStationHover} handleMouseOut={handleMouseOut} selectedStation={selectedStation}/>
